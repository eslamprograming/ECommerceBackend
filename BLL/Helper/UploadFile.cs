...
namespace BLL.Helper
{
    public static class File
    {
        ...
        {
            Stream fileStream = GetFileAsStream("ecommerce-402307-02576681cce4.json");
            string folderId = "1NjhwFQNKko77WhiumNj5D85CWRllivLd";
        ...
        public static object DeleteFileByLink(string fileLink)
        {
            try
            {
                var credential = GoogleCredential.FromStream(GetFileAsStream("ecommerce-402307-02576681cce4.json"))
